...
<form id=\"editForm\">
			<table border=0 width=\"450\">
				...
				<tr>
					<td class=\"form_row_title\">Subtitle Addon:</td>
					<td class=\"form_row_value\"><input type=\"checkbox\" value=\"1\" name=\"subtitle_on\"".iif($adinfo[subtitle_on] == 1,"checked=\"checked\"")."></td>
				</tr>
				<tr>
					<td class=\"form_row_title\">Subtitle:</td>
					<td class=\"form_row_value\"><input type=\"text\" value=\"$adinfo[subtitle]\" name=\"subtitle\"></td>
				</tr>
				<tr>
					<td class=\"form_row_title\">Icon Addon:</td>
					<td class=\"form_row_value\"><input type=\"checkbox\" value=\"1\" name=\"icon_on\"".iif($adinfo[icon_on] == 1,"checked=\"checked\"")."></td>
				</tr>
