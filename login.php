<script type="text/javascript" src="ptc/js/jquery.js"></script>
		<script type="text/javascript" src="ptc/js/jquery-ui-1.7.2.custom.min.js"></script>
		<script type="text/javascript" src="ptc/js/jquery.sexy-captcha-0.1.js"></script>
		<link rel="stylesheet" type="text/css" media="all" href="ptc/css/sexy-captcha/styles.css" />
<?
//**S**//
