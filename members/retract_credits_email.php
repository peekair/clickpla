...
//#        taken if neccessary.                                                    #
//#########################################//   
$includes[title]="Retract Email Credits";
//**VS**//$setting[ptr]//**VE**//
//**S**//
...
if(($thisad['class'] != "P") || ($thisad[forbid_retract] != 1)) {
	...
	<br />
<div align=\"center\">
<form action=\"index.php?view=account&ac=retract_credits_email&action=retract&".$url_variables."\" method=\"post\">
...
";
	...
	$includes[content]="You cannot retract the credits from this email ad!";
}
//**E**//
