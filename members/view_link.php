...
if($ad[username]!=$username) {
	...
	$includes[content]="
<form action=\"index.php?view=account&ac=view_link&action=save&id=$id&".$url_variables."\" method=\"post\">
<div style=\"text-align: right\"><a href=\"index.php?view=account&ac=myads&adtype=link&".$url_variables."\">Back To Ad Manager</a></div>
<div align=\"center\">
<table>
	<tr>
	...
	<tr>
		...
		<td>Target Banner URL: </td>
		<td><a href=\"$ad[targetban]\" target=\"_blank\">$ad[targetban]</a></td>
	</tr>
	<tr>
		<td>Credits: </td>
		<td>$ad[credits]</td>
	...
	<tr>
		...
		<td>".iif($ad['bgcolor']!="","<div style=\"background-color: $ad[bgcolor]\">$ad[bgcolor]</div>","None")."</td>
	</tr>
	...
	<tr>
		<td>Icon Addon: </td>
		<td>".iif($ad['icon_on']==1,"".iif($ad['icon']!="","<img src=\"adicons/".$ad['icon']."\" />","Yes")." <a href=\"index.php?view=account&ac=edit_icon&type=link&id=".$ad['id']."&".$url_variables."\"><sup>edit</sup></a>","No")."</td>
	</tr>
	<tr>
	...
	<tr>
		<td colspan=2 align=\"center\">
			<input type=\"button\" value=\"Delete Ad\" onclick=\"location.href='index.php?view=account&ac=delete_link&id=$id&".$url_variables."'\">
			<input type=\"button\" value=\"Add Credits\" onclick=\"location.href='index.php?view=account&ac=add_credits_link&id=$id&".$url_variables."'\">
		</td>
	</tr>
</table>
</form>
