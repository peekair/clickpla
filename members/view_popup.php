...
<form action=\"index.php?view=account&ac=view_popup&action=save&id=$id&".$url_variables."\" method=\"post\">
<div style=\"text-align: right\"><a href=\"index.php?view=account&ac=myads&adtype=popups&".$url_variables."\">Back To Ad Manager</a></div>
<div align=\"center\">
<table>
	<tr>
	...
	<tr>
		<td colspan=2 align=\"center\">
			<input type=\"button\" value=\"Delete Ad\" onclick=\"location.href='index.php?view=account&ac=delete_popup&id=$id&".$url_variables."'\">
			<input type=\"button\" value=\"Add Credits\" onclick=\"location.href='index.php?view=account&ac=add_credits_popup&id=$id&".$url_variables."'\">
		</td>
	</tr>
</table>
</form>
